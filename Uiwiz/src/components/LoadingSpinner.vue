<template>
  <div class="spinner-container flex h-screen items-center justify-center">
    <div role="status">
...
<style>
/* Use .spinner-container to ensure these rules only apply to this component's SVG */
.spinner-container svg {
  width: 300px;
}

.spinner-container svg path {
  --total-length: 115px; /* Retrieved using getTotalLength() */
